...
function myBirthYearFunc() {
  ...
  // Respuesta = Cuando llamemos a la funcion por consola se imprimira "Nací en1980".
...
function myBirthYearFunc(birthYearInput) {
  ...
  // Respuesta= El n consola se mostrara "Nací en1980 o el valor que le pasemos en el parametro".
